...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAuthForgotForgotComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAuthResetResetComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAuthAuthRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _forgot_forgot_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
  ...
  /***/
  function srcAppAuthForgotForgotComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAuthForgotForgotComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_route_animations__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ForgotComponent(authService, route) {
        var _this = this;
        ...
        this.route = route;
        this.isLoading = false; //FETCH TOKEN FROM ROUTE

        this.route.params.subscribe(function (param) {
          return _this.state = param["state"];
        });
      }
  ...
  function srcAppAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function LoginComponent(authService, route) {
        ...
        this.authService = authService;
        this.route = route;
        this.isLoading = false; //FETCH STATE FROM ROUTE LINK TO SET LOGIN GREETING FOR STARRED FEATURE

        this.route.params.subscribe(function (param) {
          return _this3.state = param["state"];
        });
      }
  ...
  /***/
  function srcAppAuthResetResetComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAuthResetResetComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ResetComponent(authService, route) {
        var _this5 = this;
        ...
        this.route.params.subscribe(function (param) {
          return _this5.token = param["token"];
        });
      }
